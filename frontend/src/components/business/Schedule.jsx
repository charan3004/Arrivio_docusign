    ...
    return (
        ...
        >
            <div className="max-w-6xl mx-auto">
                <div className="bg-[#F5F5F0]/60 backdrop-blur-md rounded-3xl p-6 md:p-10 lg:p-16 border border-white/60 shadow-xl">
                    ...
                    {/* CAL.COM IFRAME */}
                    <div className="max-w-6xl mx-auto mt-8 md:mt-16 px-0 md:px-4">
                        <iframe
                            src="https://cal.eu/zaki-amawi?theme=light&primaryColor=%231A2E22"
                            title="Arrivio Strategy Call"
                            className="w-full h-[600px] md:h-[700px] lg:h-[750px] rounded-2xl border border-black/10 bg-white"
                            loading="lazy"
                        />
                    </div>
